 ...
 class UpdateProject extends Component {
    ...
    componentWillReceiveProps(nextProps){
        ...
        start_date,
         altitude,
         longitude,
        end_date,  image} = nextProps.project ;
    ...
    componentDidMount(){
        ...
        console.log("project  1 ",this.state.project);
        ...
        <div className="container">
            <div className="row">
                <div className="col-md-8 m-auto">
                    <h5 className="display-4 text-center">Create / Edit site form</h5>
                    <hr />
                    <form onSubmit={this.onSubmit} >
                        ...
                        <h6>Start Date</h6>
                        <div className="form-group">
                            <input type="date" className={classnames("form-control form-control-lg", {"is-invalid":errors.start_date})}   name="start_date" value={this.state.start_date} onChange={this.onChange}/>
                        </div>
                        <h6>Estimated End Date</h6>
                        <div className="form-group">
                            <input type="date" className={classnames("form-control form-control-lg", {"is-invalid":errors.end_date})} name="end_date" value={this.state.end_date} onChange={this.onChange}/>
                        </div>
